    ...
    <div class="col-md-12 mt-3">
        <div class="card">
            ...
            <div class="card-header">
                ...
                <div>
                    @can('haveaccess','carrera.create')
                    <a href="{{route('carrera.create')}}" class="btn btn-primary">Nueva</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                <table id="datablegeneral" class="table table-bordered table-striped dt-responsive">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th>Name</th>
                            <th>description</th>
                            @can('haveaccess','carrera.show')
                            <th>Show</th>
                            @endcan
                            @can('haveaccess','carrera.edit')
                            <th>Edit</th>
                            @endcan
                            @can('haveaccess','carrera.destroy')
                            <th>Delete</th>
                            @endcan
