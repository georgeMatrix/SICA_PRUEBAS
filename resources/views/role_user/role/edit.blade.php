                    ...
                    <form action="{{route('role.update',$role)}}" method="post">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nombre de rol" value="{!! old('name',$role->name) !!}" required>
                            </div>
                            ...
                            <div class="form-group">
                                <textarea name="description" id="description" class="form-control" placeholder="Descripción">{!! old('description',$role->description) !!}</textarea>
                            </div>
