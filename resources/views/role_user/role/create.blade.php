                    ...
                    <form action="{{route('role.store')}}" method="post">
                        ...
                        <div class="container">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="name" name="name" placeholder="Nombre de rol" value="{!! old('name') !!}" required>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab_category_permission" role="tablist">
                                        <a class="nav-item btn btn btn-dark active mr-3" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="presentation" aria-controls="nav-home" aria-selected="true">Todos los permisos</a>
